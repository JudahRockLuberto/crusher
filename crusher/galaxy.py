...
class GalaxyMap(object):
    ...
    def aper_summary(self, gal_only=False, output=False):
        ...
        if 'map_star_sigma_insitu_{}'.format(self.proj) in self.hdf5_values and 'map_star_sigma_exsitu_{}'.format(self.proj) in self.hdf5_values and 'map_star_sigma_{}'.format(self.proj) in self.hdf5_values:
